...
export class Summary {
    ...
    public static clone(data: any) {
        const result = new Summary(data.facilityId, data.checkinDate);
        result.total$$ = data.total$$;
        result.totalAG = data.totalAG;
        result.totalCT = data.totalCT;
        result.totalFM = data.totalFM;
        result.totalMM = data.totalMM;
        result.totalSW = data.totalSW;
        result.totalUK = data.totalUK;
        result.totalWB = data.totalWB;
        result.totalAmount = data.totalAmount;
        result.totalAssigned = data.totalAssigned;
        result.totalMats = data.totalMats;
        result.totalUnassigned = data.totalUnassigned;
        result.percentAssigned = data.percentAssigned;
        result.percentUnassigned = data.percentUnassigned;
        result.totalAmountDisplay = data.totalAmountDisplay;
        return result;
    }
